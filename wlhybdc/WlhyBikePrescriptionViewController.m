//
//  WlhyBikePrescriptionViewController.m
//  wlhybdc
//
...
#import "WlhyBikePrescriptionViewController.h"
...
@interface WlhyBikePrescriptionViewController () <UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate, UIAlertViewDelegate>
{
...
@implementation WlhyBikePrescriptionViewController
...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    if ([_temporaryTrainID integerValue] != -1 && _isBackFromTrainSelection) {
        UIViewController *destVC = [self.storyboard instantiateViewControllerWithIdentifier:@"WlhyBikeSportViewController"];
...
- (void)setUIWithPrescInfo
{
    ...
    if (![picUrlString isEqualToString:@""]) {
        ...
        [_equipImageView setImage:[UIImage imageNamed:@"jrcf_dc_img.jpg"]];
    }

...
#import "WlhyBikeSportViewController.h"
...
@interface WlhyBikeSportViewController () <IFlySpeechSynthesizerDelegate, UITableViewDelegate, UITableViewDataSource, UINavigationBarDelegate, UIAlertViewDelegate, UIActionSheetDelegate, WlhyXMPPDelegate, DropButtonViewDelegate>
{
    float totalDistance;
    float totalTime;
...
@implementation WlhyBikeSportViewController
...
- (void)sportStart
{
    ...
    NSString *messageString = [NSString stringWithFormat:@"我在单车上开始了运动，当前为第%i阶段", currentStep+1];

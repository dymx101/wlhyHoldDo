//
//  WlhyTyjPrescriptionViewController.m
//  wlhybdc
//
...
#import "WlhyTyjPrescriptionViewController.h"
...
@interface WlhyTyjPrescriptionViewController () <UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate, UIAlertViewDelegate>
{
...
@implementation WlhyTyjPrescriptionViewController
...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    if ([_temporaryTrainID integerValue] != -1 && _isBackFromTrainSelection) {
        UIViewController *destVC = [self.storyboard instantiateViewControllerWithIdentifier:@"WlhyTyjSportViewController"];
...
- (void)setUIWithPrescInfo
{
    ...
    if (![picUrlString isEqualToString:@""]) {
        ...
        [_equipImageView setImage:[UIImage imageNamed:@"jrcf_tyj_img.jpg"]];
    }
